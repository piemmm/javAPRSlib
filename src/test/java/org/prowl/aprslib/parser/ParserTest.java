...
//      System.out.println("Type:" + packet.getAprsInformation().getTypes());
//      assertTrue(packet.getAprsInformation().containsType(APRSTypes.T_WX), "Parsed packet is not of type weather");
//   }
   ...
   public void parseMessage() throws Exception {
      ...
      System.out.println("Type:" + packet.getAprsInformation().getTypes());
      assertTrue(packet.getAprsInformation().containsType(APRSTypes.T_MESSAGE),"Parsed packet is not of type message");
   }
   ...
   public void parseTelemetry() throws Exception {
      ...
      assertTrue(packet.getAprsInformation().containsType(APRSTypes.T_TELEMETRY), "Parsed packet is not of type telemetry");
   }
